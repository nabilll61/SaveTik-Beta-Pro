        ...
        if (response.data && response.data.code === 0 && response.data.data) {
          ...
          if (resData.images && Array.isArray(resData.images)) {
            ...
            if (videoUrl) {
              ...
              directLinks.push({
                quality: 'Download No Watermark HD)',
                format: 'mp4',
                size: '15.4 MB',
            ...
            if (wmVideoUrl) {
              ...
              directLinks.push({
                quality: 'Download Dengan Watermark HD',
                format: 'mp4',
                size: '16.8 MB',
      ...
      try {
        ...
        if (capcutRes && capcutRes.data) {
          ...
          if (capData.videos && capData.videos.length > 0) {
            ...
            const qualityLabelNoWm = v.size ? `Video CapCut No Watermark ${v.size}` : `Video CapCut No Watermark`;
            directLinks.push({
