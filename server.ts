...
let serverApkUpdate = {
  active: false,
  version: 'v2.0.0',
  title: 'SaveTik Update!!',
  notice: 'Pembaruan Tersedia Segera Update Versi Neww',
  changelog: [
    'SaveTik-Beta All Download Media'
  ],
  downloadUrl: 'https://www.nabil-official.web.id/public/SavetTik-Beta-v2.0.0.apk',
  forceUpdate: false
};
