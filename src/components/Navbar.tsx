...
import { Menu, X, Sun, Moon, Smartphone, LogOut, Home, BookOpen, ShieldAlert, Heart, MessageSquare, Star, Clock } from 'lucide-react';

interface NavbarProps {
  activeView: 'downloader' | 'guide' | 'restrictions' | 'donation' | 'history' | 'feedback' | 'favorites' | 'offline' | 'admin';
  onViewChange: (view: 'downloader' | 'guide' | 'restrictions' | 'donation' | 'history' | 'feedback' | 'favorites' | 'offline' | 'admin') => void;
  theme: 'light' | 'dark';
  onThemeToggle: () => void;
