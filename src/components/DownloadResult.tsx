...
const cleanOriginalSound = (text: string) => {
  if (!text) return '';
  return text.replace(/^\s*Original\s+\s*-\s*/i, '');
};
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-black text-neo-text mt-1 truncate max-w-[180px] sm:max-w-[280px]" title={cleanOriginalSound(getAudioTitle())}>
