import { ArrowLeft, Slash, AlertTriangle, Ban, XCircle, ShieldAlert } from 'lucide-react';
    ...
    <div className="max-w-3xl mx-auto px-4 py-8" id="restrictions-section">
      ...
      <section className="mb-12">
        ...
        <div className="bg-[#FCD34D] border-[3px] border-neo-border p-5 rounded-[10px] shadow-[4px_4px_0px_0px_var(--neo-border)] mb-8">
          <p className="font-heading font-black text-xs md:text-sm tracking-wide text-black uppercase leading-relaxed flex items-start gap-2.5">
            <AlertTriangle size={20} className="text-black shrink-0 mt-0.5 stroke-[2.5]" />
            <span>
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="bg-neo-card p-5 border-[3px] border-neo-border rounded-[10px] shadow-[4px_4px_0px_0px_#E11D48] flex gap-4 items-start transition-colors">
            <div className="w-10 h-10 bg-[#FFD1D1] dark:bg-[#4A1D1D] border-[3px] border-neo-border flex items-center justify-center text-[#E11D48] shrink-0">
              <Ban size={22} className="stroke-[3]" />
            </div>
            <div>
          ...
          <div className="bg-neo-card p-5 border-[3px] border-neo-border rounded-[10px] shadow-[4px_4px_0px_0px_#E11D48] flex gap-4 items-start transition-colors">
            <div className="w-10 h-10 bg-[#FFD1D1] dark:bg-[#4A1D1D] border-[3px] border-neo-border flex items-center justify-center text-[#E11D48] shrink-0">
              <ShieldAlert size={22} className="stroke-[3]" />
            </div>
            <div>
              <h3 className="font-heading font-black text-sm md:text-base uppercase tracking-wide text-neo-text mb-1">
