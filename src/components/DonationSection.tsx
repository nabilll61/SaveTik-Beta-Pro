    ...
    <div className="max-w-3xl mx-auto px-4 py-8" id="donation-section">
      ...
      <section className="mb-12">
        ...
        <div className="mb-8 max-w-[280px] sm:max-w-[320px] mx-auto flex flex-col gap-3">
          <div 
            className="relative border-[3px] border-neo-border rounded-[15px] overflow-hidden shadow-[5px_5px_0px_0px_#E11D48] bg-neo-card select-none"
            title="Gambar QR Code Donasi"
          >
            {!imageError ? (
              <img 
                src={donationBanner} 
