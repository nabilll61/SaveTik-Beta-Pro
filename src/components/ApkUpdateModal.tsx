...
export const ApkUpdateModal: React.FC<ApkUpdateModalProps> = ({ isOpen, onClose, config }) => {
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3.5 mb-5 select-none">
            <div className="w-12 h-12 rounded-[18px] bg-gradient-to-tr from-[#6366F1] to-[#D946EF] p-[1.5px] shadow-lg shrink-0">
