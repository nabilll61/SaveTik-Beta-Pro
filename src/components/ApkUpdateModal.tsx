...
export const ApkUpdateModal: React.FC<ApkUpdateModalProps> = ({ isOpen, onClose, config, onAdminAccess }) => {
        ...
        >
          ...
          <div className="flex items-center gap-3.5 mb-5 select-none">
            <button
              ...
              className="w-12 h-12 rounded-[18px] bg-gradient-to-tr from-[#6366F1] to-[#D946EF] p-[1.5px] shadow-lg shrink-0 hover:scale-105 active:scale-95 transition-all cursor-pointer border-none bg-transparent"
              title="Akses Admin"
            >
            ...
            <div>
              <h3 className="font-black text-sm text-neutral-200 tracking-tight leading-none uppercase">SaveTik Beta</h3>
